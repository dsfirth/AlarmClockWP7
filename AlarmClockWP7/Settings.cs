...
namespace AlarmClockWP7
{
    ...
    public class Settings
    {
        ...
        public static readonly Setting<Color> ForegroundColor =
            new Setting<Color>("ForegroundColor", () => (Color)Application.Current.Resources["PhoneAccentColor"]);

        public static readonly Setting<Color> BackgroundColor =
            new Setting<Color>("BackgroundColor", () => (Color)Application.Current.Resources["PhoneBackgroundColor"]);

        public static readonly Setting<bool> DisableScreenLock = new Setting<bool>("DisableScreenLock", true);
        public static readonly Setting<bool> Show24Hours = new Setting<bool>("Show24Hours");
