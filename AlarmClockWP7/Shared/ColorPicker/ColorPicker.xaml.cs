...
namespace AlarmClockWP7.Shared.ColorPicker
{
    public partial class ColorPickerPage : PhoneApplicationPage
    {
        private HSVColor currentColor;
        private HSVColor defaultColor;
        private bool keyPressed;
        private bool showOpacity = true;
        ...
        public void SetCurrentColor(HSVColor value)
        {
            ...
            Point saturationValuePoint = new Point(value.S*this.SaturationValueMap.Width,
                                                    value.V*this.SaturationValueMap.Height);
        ...
        private void SatValMove(object sender, MouseEventArgs e)
        {
            keyPressed = false;
        ...
        private void AlphaMove(object sender, MouseEventArgs e)
        {
            keyPressed = false;
        ...
        private bool TryGetColorFromText(string text, out Color color)
        {
            try
            {
                ...
                Rectangle rect =
                    XamlReader.Load(
                        "<Rectangle xmlns='http://schemas.microsoft.com/winfx/2006/xaml/presentation' Fill='" + text +
                        "'/>") as Rectangle;
